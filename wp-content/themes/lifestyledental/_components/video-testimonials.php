...
<?php if (! isset($_GET['dev'])) : ?>
	...
	<div class="comp__video-testimonials text-center d-none d-lg-block">
		<div class="container">
			<h2 class="inverted ">A personal approach to getting your smile back</h2>
			...
			<div class="testimonial-videos inverted">
				<div class="row">
					...
					<div class="col-lg-4">
						...
						<p>Made a massive impact to my smile - <span>Jo</span> </p>
					...
					<div class="col-lg-4">
						...
						<p>Really happy with the results! - <span>Nicola</span> </p>
	...
	<div class="comp__video-testimonials text-center d-lg-none">
		<div class="container">
			<h2 class="inverted ">A personal approach to getting your smile back</h2>
...
<?php else : ?>
	...
	<div class="comp__video-testimonials text-center">
		<div class="container">
			<h2 class="inverted text-uppercase">What Our Happy Customers Are Saying</h2>
