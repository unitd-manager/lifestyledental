...
<h3 id="pid"><u>I. Google Place ID</u></h3>
...
<div class="{slg}-flex-row">
    <div class="{slg}-flex-col3">
        <b>1</b> Search for your business on Google.
    </div>
    <div class="{slg}-flex-col7">
        <div class="box-img"><img src="<?php echo Plugin::ASSETS_URL() . 'img/google_placeid_1.png'; ?>"></div>
    </div>
</div>
...
<div class="{slg}-flex-row">
    ...
    <div class="{slg}-flex-col7">
        <div class="box-img"><img src="<?php echo Plugin::ASSETS_URL() . 'img/google_placeid_2.png'; ?>"></div>
    </div>
</div>
...
<div class="{slg}-flex-row">
    ...
    <div class="{slg}-flex-col7">
        <div class="box-img"><img src="<?php echo Plugin::ASSETS_URL() . 'img/google_placeid_3.png'; ?>"></div>
    </div>
</div>
...
<div class="{slg}-flex-row">
    ...
    <div class="{slg}-flex-col">
        <div class="box-img"><img src="<?php echo Plugin::ASSETS_URL() . 'img/google_key_1.png'; ?>"></div>
    </div>
</div>
...
<div class="{slg}-flex-row">
    ...
    <div class="{slg}-flex-col">
        <div class="box-img"><img src="<?php echo Plugin::ASSETS_URL() . 'img/google_key_2.png'; ?>"></div>
        <div class="box-img"><img src="<?php echo Plugin::ASSETS_URL() . 'img/google_key_2_1.png'; ?>"></div>
    </div>
</div>
...
<div class="{slg}-flex-row">
    ...
    <div class="{slg}-flex-col">
        <div class="box-img"><img src="<?php echo Plugin::ASSETS_URL() . 'img/google_key_3.png'; ?>"></div>
    </div>
</div>
...
<div class="{slg}-flex-row">
    ...
    <div class="{slg}-flex-col">
        <div class="box-img"><img src="<?php echo Plugin::ASSETS_URL() . 'img/google_key_4.png'; ?>"></div>
        <div class="box-img"><img src="<?php echo Plugin::ASSETS_URL() . 'img/google_key_4_1.png'; ?>"></div>
    </div>
</div>
...
<div class="{slg}-flex-row">
    ...
    <div class="{slg}-flex-col">
        <div class="box-img"><img src="<?php echo Plugin::ASSETS_URL() . 'img/google_key_5.png'; ?>"></div>
    </div>
</div>
...
<div class="{slg}-flex-row">
    ...
    <div class="{slg}-flex-col">
        <div class="box-img"><img src="<?php echo Plugin::ASSETS_URL() . 'img/google_key_6.png'; ?>"></div>
    </div>
</div>
...
<div class="{slg}-flex-row">
    ...
    <div class="{slg}-flex-col">
        <div class="box-img"><img src="<?php echo Plugin::ASSETS_URL() . 'img/google_key_7.png'; ?>"></div>
    </div>
</div>
...
<div class="{slg}-flex-row">
    ...
    <div class="{slg}-flex-col">
        <div class="box-img"><img src="<?php echo Plugin::ASSETS_URL() . 'img/google_key_8.png'; ?>"></div>
    </div>
</div>
...
<p style="text-align:center"><b>Congratulation! Now you need to <a href="<?php echo admin_url('admin.php?page=' . Plugin::SLG . '-builder'); ?>" target="_blank">create your first widget and connect Google reviews</a>,<br>then you can show this widget in a sidebar or like a shortcode on the any page of your website.</b></p>

<?php echo preg_replace('/{slg}/', Plugin::SLG, ob_get_clean()); ?>