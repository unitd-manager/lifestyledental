...
function wp_cache_set( $key, $data, $group = '', $expire = 0 ) {
	...
	# wpe: store in db even with object cache enabled
	if ($group == 'site-transient' && in_array($key, ['update_core', 'update_plugins', 'update_themes'])) {
...
function wp_cache_set_multiple( array $data, $group = '', $expire = 0 ) {
	...
	if ($group == 'site-transient') {
		foreach ( $data as $key => $value ) {
			if (in_array($key, ['update_core', 'update_plugins', 'update_themes'])) {
				wp_using_ext_object_cache(false);
