...
.root-canal-combined-panel {
    background:#ffffff;
    border:1px solid #e0e0e0;
    border-top:5px solid #683fa1;
    border-radius:8px;
    padding:30px;
    font-size:18px;
    font-weight:400;
...
.root-canal-panel-image {
    width:100%;
    height:auto;
    border-radius:6px;
}

.root-canal-panel-content h3 {
    color:#683fa1;
    font-weight:400;
    margin-bottom:15px;
}

.root-canal-panel-content ul {
    list-style:none;
    padding-left:0;
    margin:15px 0;
}

.root-canal-panel-content ul li {
    margin-bottom:8px;
    position:relative;
    padding-left:22px;
}

.root-canal-panel-content ul li::before {
    content:"✔";
    color:#683fa1;
    position:absolute;
    left:0;
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-4 mb-4 mb-lg-0">
                    <img
                        ...
                        class="root-canal-panel-image">
                </div>

                <!-- CONTENT -->
                <div class="col-12 col-lg-8 root-canal-panel-content">
                    ...
                    <p>
                        ...
                        if left untreated. Infection inside the tooth can lead to severe pain,
                        swelling, and damage to surrounding bone and tissue.
                    </p>
                    ...
                    <p class="root-canal-highlight">
                        Seeking timely root canal treatment can protect your oral health and
                        help you avoid more complex dental procedures.
                    </p>
...
<section class="text-image-section">
  <div class="text-image-wrapper">
    ...
    <div class="text-content">
      <h3>Enhance Your Smile with Porcelain Veneers</h3>

      <p>
       Porcelain veneers are a premium cosmetic solution for improving tooth colour, shape and alignment. Custom-made and natural-looking, they deliver a confident, radiant smile with minimal tooth reduction. Each veneer is carefully designed to enhance facial harmony, restore balance, and provide long-lasting, stain-resistant results.
      </p>

      <!-- CHECKLIST -->
      <ul class="veneer-checklist">
        <li>✔ Instantly improve tooth colour and shape</li>
        <li>✔ Natural-looking, long-lasting porcelain</li>
        <li>✔ Minimal tooth preparation required</li>
        <li>✔ Custom-designed for your smile</li>
      </ul>
      ...
      <div class="info-cards">
        <div class="info-card">
          ...
          <p>
            Veneers are carefully colour-matched to blend seamlessly
        ...
        <div class="info-card">
          <h4>Long-Lasting</h4>
          <p>
            With proper care, porcelain veneers can last many years
      ...
      <a href="#contact-form" class="btn-primary">Book Your Consultation</a>
    </div>

    <!-- RIGHT IMAGE -->
    <div class="image-content">
      <img src="/image/about/quick.webp" alt="Porcelain Veneers Example">
    </div>
			...
			<section class="meet_the_team_block">
				<div class="container">
					<?php for ($i = 0; $i < count($members); $i++) : $member = $members[$i]; ?>
						...
						<?php if ($i < count($members) - 1) : ?><hr><?php endif; ?>
					<?php endfor; ?>
				</div>
			</section>
